...
int main(int argc, char *argv[]) {
  ...
  // You describe position of top left corner of wall (x, y), then width and
  // height going down/to right Relative positions are used
  // (OVERALL_WINDOW_WIDTH and OVERALL_WINDOW_HEIGHT) But you can use absolute
  // positions. 10 is used as the width, but you can change this.
